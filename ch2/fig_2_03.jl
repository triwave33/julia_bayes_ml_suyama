...
a = bar(x_scale, p_arr[:,1], title=L"M=10, \mu=0.5", label="",
          color=color, xlabel="m", ylabel="probability",
          titlefont=fs, bar_edges=true,
          left_margin=margin, right_margin=margin)
b = bar(x_scale, p_arr[:,2], title=L"M=10, \mu=0.2", label="",
          titlefont=fs, bar_edges= true,
          color=color, xlabel="m", ylabel="probability")

c = bar(x_scale, p_arr[:,3], title=L"M=20, \mu=0.6", label="",
          titlefont=fs, bar_edges=true,
          color=color, xlabel="m", ylabel="probability")
plot(a,b,c, layout=l)
savefig("fig_2_03.png")
